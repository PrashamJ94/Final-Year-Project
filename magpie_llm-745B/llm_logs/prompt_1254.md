...
Available parents:
 Parent 1:
 with fitness 50.0
Parent 1 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 27), ('Triangle.java.xml', 'stmt', 9))"]
 Parent 2:
 with fitness 75.0
Parent 2 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 8), ('Triangle.java.xml', 'stmt', 10))"]
 Parent 3:
 with fitness 75.0
Parent 3 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 14))"]
 Parent 4:
 with fitness 75.0
Parent 4 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 3), ('Triangle.java.xml', 'stmt', 2))"]
 Parent 5:
 with fitness 75.0
Parent 5 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 6), ('Triangle.java.xml', 'stmt', 2))"]
