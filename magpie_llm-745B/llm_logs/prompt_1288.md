...
Parent 2 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 9))"]
 Parent 3:
 with fitness 10.0
Parent 3 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 0))"]
 Parent 4:
 with fitness 10.0
...
Parent 6 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 6))"]
 Parent 7:
 with fitness inf
Parent 7 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 3))"]
 Parent 8:
 with fitness inf
Parent 8 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 8))"]
 Parent 9:
 with fitness inf
Parent 9 has 1 edits: ["SrcmlLLMTypeReplacement(('com/example/HumanEval_55.java.xml', 'stmt', 2))"]
 Parent 10:
 with fitness inf
