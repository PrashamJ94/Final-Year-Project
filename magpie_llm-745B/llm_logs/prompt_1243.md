...
Available parents:
 Parent 1:
 with fitness 50.0
Parent 1 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 7))"]
 Parent 2:
 with fitness 50.0
Parent 2 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 5), ('Triangle.java.xml', 'stmt', 0))"]
 Parent 3:
 with fitness 50.0
Parent 3 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 20), ('Triangle.java.xml', 'stmt', 10))"]
 Parent 4:
 with fitness 75.0
Parent 4 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 0))"]
 Parent 5:
 with fitness 75.0
Parent 5 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 3))"]
