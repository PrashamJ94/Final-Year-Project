...
Parent 2 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 10))"]
 Parent 3:
 with fitness 50.0
Parent 3 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 29), ('Triangle.java.xml', 'stmt', 9))"]
 Parent 4:
 with fitness 50.0
Parent 4 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 16))"]
 Parent 5:
 with fitness 50.0
Parent 5 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 11), ('Triangle.java.xml', 'stmt', 7))"]
