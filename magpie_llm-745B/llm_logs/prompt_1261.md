...
Available parents:
 Parent 1:
 with fitness 50.0
Parent 1 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 16))"]
 Parent 2:
 with fitness 50.0
Parent 2 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 10), ('Triangle.java.xml', 'stmt', 10))"]
 Parent 3:
 with fitness 75.0
Parent 3 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 8))"]
 Parent 4:
 with fitness 75.0
Parent 4 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 3))"]
 Parent 5:
 with fitness 75.0
Parent 5 has 1 edits: ["SrcmlStmtReplacement(('Triangle.java.xml', 'stmt', 8), ('Triangle.java.xml', 'stmt', 6))"]
