...
Available parents:
 Parent 1:
 with fitness 50.0
Parent 1 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 17), ('Triangle.java.xml', 'stmt', 11))"]
 Parent 2:
 with fitness 50.0
Parent 2 has 1 edits: ["SrcmlStmtInsertion(('Triangle.java.xml', '_inter_block', 12), ('Triangle.java.xml', 'stmt', 12))"]
 Parent 3:
 with fitness 50.0
Parent 3 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 7))"]
 Parent 4:
 with fitness 75.0
Parent 4 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 8))"]
 Parent 5:
 with fitness 75.0
Parent 5 has 1 edits: ["SrcmlStmtDeletion(('Triangle.java.xml', 'stmt', 11))"]
