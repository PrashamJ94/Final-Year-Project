...
from .xml_edits import (
    ...
    AbstractXmlLLMReplacement
)

class SrcmlLLMTypeReplacement(AbstractXmlLLMReplacement):
    NODE_TAG = 'stmt'

magpie.utils.known_edits.append(SrcmlLLMTypeReplacement)

class SrcmlBooleanReplacement(AbstractXmlLLMReplacement):
    NODE_TAG = 'stmt'

magpie.utils.known_edits.append(SrcmlBooleanReplacement)
